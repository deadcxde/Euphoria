...
local themes = {
    ...
    OptionColor = Color3.fromRGB(255,255,255),
...
local themeStyles = {
    DarkTheme = {
        ...
        TextColor = Color3.fromRGB(255,255,255),
        OptionColor = Color3.fromRGB(30,30,30),
...
local Name = "EuphoriaUIConfig.JSON"
...
function EuphoriaUI.CreateLib(kavName, themeList)
    ...
    table.insert(EuphoriaUI, kavName)
    ...
    EuphoriaUI:DraggingEnabled(MainHeader, Main)
    ...
    tabFrames.Size = UDim2.new(0, 135, 0, 240)
    ...
    function EuphoriaUI:ChangeColor(prope,color)
    ...
    function Tabs:NewTab(tabName)
        ...
        local imgTab = Instance.new("ImageLabel")
        ...
        imgTab.Name = "touch"
        imgTab.Parent = tabButton
        imgTab.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        imgTab.BackgroundTransparency = 1.000
        imgTab.BorderColor3 = Color3.fromRGB(27, 42, 53)
        imgTab.Position = UDim2.new(0.0199999996, 0, 0.180000007, 0)
        imgTab.Size = UDim2.new(0, 21, 0, 21)
        imgTab.Image = "rbxassetid://3926305904"
        imgTab.ImageColor3 = themeList.SchemeColor
        Objects[imgTab] = "SchemeColor"
        imgTab.ImageRectOffset = Vector2.new(84 - 36, 204)
        imgTab.ImageRectSize = Vector2.new(36, 36)
        imgTab.ImageTransparency = 0
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewButton(bname,tipINf, callback)
                ...
                Sample.Image = "http://www.roblox.com/asset/?id=3926305904"
            ...
            function Elements:NewDropdown(dropname, dropinf, list, callback)
                ...
                for i,v in next, list do
                    ...
                    optionSelect.BackgroundColor3 = themeList.OptionColor
                    ...
                    optionSelect.MouseEnter:Connect(function()
                        if not focusing then
                            game.TweenService:Create(optionSelect, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                                BackgroundColor3 = Color3.fromRGB(themeList.OptionColor.r * 255 + 8, themeList.OptionColor.g * 255 + 9, themeList.OptionColor.b * 255 + 10)
                            }):Play()
                            oHover = true
                        end 
                    end)
                    optionSelect.MouseLeave:Connect(function()
                        if not focusing then
                            game.TweenService:Create(optionSelect, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
                                BackgroundColor3 = themeList.OptionColor
                            }):Play()
                            oHover = false
                        end
                    end)   
            ...
            function Elements:NewLabel(title)
            	...
            	label.Text = title
           		label.Size = UDim2.new(0, 352, 0, 18)
