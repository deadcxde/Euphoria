                        ...
                        if not game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible then
                            ...
                            for i, plr in pairs(game:GetService("Players"):GetChildren()) do
                                if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, plr.Name) then
                                    ...
                                    until not _G.AutoFarmPlayer or not v.Parent or v.Humanoid.Health <= 0 or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false or not v:FindFirstChild("HumanoidRootPart")
                                end 
                            end
                        end
                    end
